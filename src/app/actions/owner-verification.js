    ...
    try {
        ...
        return {
            ...
            paymentParams: {
                ...
                currency: currency,
                hash: hash,
                first_name: listing.owner_name?.split(' ')[0] || "Property",
                last_name: listing.owner_name?.split(' ').slice(1).join(' ') || "Owner",
                email: listing.owner_email || listing.contact_email || "noreply@landsale.lk",
                phone: listing.owner_phone || listing.contact_phone || "",
                address: listing.address || listing.location || "Sri Lanka",
                city: listing.city || listing.district || "Colombo",
                country: "Sri Lanka"
            }
        };
