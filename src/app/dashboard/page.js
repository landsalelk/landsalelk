...
<<<<<<< HEAD
  const loadDashboardData = useCallback(async () => {
    try {
      ...
      const views = userListings.reduce(
        (acc, listing) => acc + (listing.views_count || 0),
        0,
      );
      setTotalViews(views);
...
>>>>>>> ced6621fe59b1161996e305a12e4cb3821b4ac5d
        ...
        const [totalInquiriesRes, last30DaysRes, prev30DaysRes] =
          await Promise.all([
            databases.listDocuments(
              DB_ID,
              COLLECTION_MESSAGES,
            ...
            databases.listDocuments(DB_ID, COLLECTION_MESSAGES, [
              Query.equal("receiver_id", userData.$id),
              Query.greaterThanEqual("timestamp", thirtyDaysAgo.toISOString()),
              Query.limit(1),
            ]),
...
>>>>>>> ced6621fe59b1161996e305a12e4cb3821b4ac5d
  ...
  return (
    <div className="animate-fade-in min-h-screen bg-slate-50 pt-20">
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="flex flex-col gap-8 lg:flex-row">
          {/* Sidebar */}
          <aside className="space-y-6 lg:w-64">
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="mb-4 flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-[#10b981] to-[#06b6d4] text-xl font-bold text-white shadow-lg">
                  {user?.name?.charAt(0).toUpperCase() || "U"}
                </div>
                <div>
                  <h2 className="font-bold text-slate-800">{user?.name}</h2>
              ...
              {kycStatus === "approved" ? (
                ...
                <Link
                  href="/kyc"
                  className="flex items-center justify-between rounded-xl bg-slate-100 p-3 text-sm text-slate-600 transition-colors hover:bg-slate-200"
                >
                  <span className="flex items-center gap-2">
            ...
            {/* Navigation */}
            <nav className="glass-card space-y-1 rounded-2xl p-3">
              {navItems.map((item) =>
                item.link ? (
                  <Link
                    key={item.id}
                    href={item.link}
                    className="flex w-full items-center gap-3 rounded-xl px-4 py-3 font-medium text-slate-600 transition-colors hover:bg-slate-100"
                  >
                  ...
                  <button
                    key={item.id}
                    onClick={() => setActiveSection(item.id)}
                    className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 font-medium transition-colors ${
            ...
            <Link
              href="/properties/create"
              className="block rounded-2xl bg-gradient-to-r from-[#10b981] to-[#06b6d4] p-4 text-center font-bold text-white shadow-lg shadow-[#10b981]/30 transition-all hover:shadow-xl"
            >
            ...
            {activeSection === "overview" && (
              <div className="animate-fade-in space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                  <div className="glass-card rounded-2xl p-5">
                    <div className="mb-3 flex items-center justify-between">
                      ...
                      <span
                        className={`flex items-center gap-1 text-xs font-bold ${stats.viewsChange >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                        {stats.viewsChange >= 0 ? (
                  ...
                  <div className="glass-card rounded-2xl p-5">
                    <div className="mb-3 flex items-center justify-between">
                      ...
                      <span
                        className={`flex items-center gap-1 text-xs font-bold ${stats.inquiriesChange >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                  ...
                  {listings.length > 0 ? (
                    ...
                    <div className="rounded-2xl border-2 border-dashed border-slate-200 py-12 text-center">
                      ...
                      <p className="mb-4 text-slate-500">
                        Start selling by posting your first property
                      </p>
                      <Link
                        href="/properties/create"
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-900 to-purple-900 p-8 text-white">
                  <div className="absolute top-0 right-0 -mt-32 -mr-32 h-64 w-64 rounded-full bg-purple-500/20 blur-3xl" />
                  <div className="relative z-10 flex items-center justify-between">
                    <div>
                      ...
                      <p className="max-w-md text-sm text-white/70">
                        Upgrade to Premium for verified badge, priority support,
                        and featured listings
                      </p>
                    </div>
                    <Link
                      href="/profile"
                      className="rounded-xl bg-white px-6 py-3 font-bold text-indigo-900 shadow-lg transition-colors hover:bg-amber-400 hover:text-white"
                    >
                      Upgrade Now
                    </Link>
                  </div>
            ...
            {activeSection === "listings" && (
              <div className="animate-fade-in space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href="/properties/create"
                    className="flex items-center gap-2 rounded-xl bg-[#10b981] px-4 py-2 font-medium text-white shadow-lg shadow-[#10b981]/30 hover:bg-[#059669]"
                  >
                ...
                {listings.length > 0 ? (
                    ...
                    {listings.map((prop) => {
                      ...
                      return (
                        <div key={prop.$id} className="group relative">
                          ...
                          {(isExpiring || isExpired) && (
                            <div
                              className={`absolute top-3 left-3 z-10 rounded px-2 py-1 text-xs font-bold shadow-sm ${
                                isExpired
                          ...
                          <div className="absolute top-3 right-3 flex flex-wrap justify-end gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                            {(isExpiring || isExpired) && (
                              <button
                                onClick={() => handleRenew(prop.$id)}
                                className="flex items-center gap-1 rounded-lg bg-emerald-600 px-3 py-1.5 text-sm font-medium text-white shadow-lg hover:bg-emerald-700"
                              >
                            ...
                            <button
                              onClick={() => setAnalyticsListing(prop)}
                              className="flex items-center gap-1 rounded-lg bg-white px-3 py-1.5 text-sm font-medium text-slate-600 shadow-lg hover:bg-slate-50"
                            >
                              <BarChart3 className="h-3 w-3" /> Stats
                            </button>
                            <Link
                              href={`/properties/${prop.$id}/edit`}
                              className="rounded-lg bg-white px-3 py-1.5 text-sm font-medium text-slate-600 shadow-lg hover:bg-slate-50"
                            >
                              Edit
                            </Link>
                          </div>
                  ...
                  <div className="glass-card rounded-2xl p-12 text-center">
                    <Home className="mx-auto mb-4 h-16 w-16 text-slate-300" />
                    ...
                    <Link
                      href="/properties/create"
                      className="inline-flex items-center gap-2 rounded-xl bg-[#10b981] px-6 py-3 font-bold text-white shadow-lg"
                    >
                        ...
                        <tbody className="divide-y divide-slate-100 text-sm">
                          {offersReceived.map((offer) => (
                            <tr key={offer.$id} className="hover:bg-slate-50">
                              <td className="px-4 py-3 font-medium text-slate-900">
                                <Link
                                  href={`/properties/${offer.listing_id}`}
                              ...
                              <td className="px-4 py-3 font-bold">
                                LKR {offer.offer_amount.toLocaleString()}
                              </td>
                                ...
                                {offer.status === "pending" && (
                                  <div className="flex gap-2">
                                    ...
                                    <button
                                      ...
                                      className="rounded border border-red-200 bg-red-50 px-3 py-1 text-xs font-bold text-red-600 hover:bg-red-100"
                                    >
                                      Reject
                                    </button>
                                  </div>
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        defaultValue={user?.name}
                        className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-[#10b981]"
                      />
                    </div>
                    <div>
                      <label className="mb-1 block text-sm font-medium text-slate-600">
                    ...
                    <button
                      type="submit"
                      className="rounded-xl bg-[#10b981] px-6 py-3 font-bold text-white transition-colors hover:bg-[#059669]"
                    >
                      Save Changes
                    </button>
                  </form>
