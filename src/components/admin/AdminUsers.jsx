...
import { DB_ID, COLLECTION_USERS_EXTENDED, COLLECTION_AGENTS } from '@/lib/constants';
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 transition-colors text-sm w-64"
                    />
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div className="p-4 border-t border-slate-100 flex justify-end gap-2">
                    <button
                        ...
                        className="px-3 py-1 text-sm font-bold text-slate-500 hover:bg-slate-100 rounded disabled:opacity-50"
                    >
                        Prev
                    </button>
                    <button
                        onClick={() => setPage(p => p + 1)}
                        className="px-3 py-1 text-sm font-bold text-slate-500 hover:bg-slate-100 rounded"
                    >
                        Next
                    </button>
                </div>
