...
export function PropertyCard({ property }) {
  ...
  return (
    <Link href={`/properties/${propertyId}`} className="group block">
      <div className="glass-card animate-fade-in flex h-full cursor-pointer flex-row items-stretch overflow-hidden rounded-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl md:flex-col md:rounded-[2rem]">
        {/* Image */}
        <div className="relative m-2 w-[130px] shrink-0 overflow-hidden rounded-xl md:m-2 md:aspect-[4/3] md:w-auto md:rounded-[1.5rem]">
          <Image
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-center p-3 md:justify-start md:p-5">
          ...
          <div className="mb-2 md:mb-3">
            ...
            <div className="mt-1.5 flex items-center text-xs font-medium text-slate-500 md:text-sm">
              <MapPin className="text-primary-400 mr-1 h-3 w-3 flex-shrink-0 md:h-4 md:w-4" />
