...
export const metadata: Metadata = {
    ...
    description: "Browse our comprehensive list of lands, houses, and commercial properties for sale in Sri Lanka.",
}
...
export default async function PropertiesPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    try {
        ...
        if (province && province !== 'all') {
            ...
            // This is a simplified approach - in production you'd want to use a more sophisticated method
